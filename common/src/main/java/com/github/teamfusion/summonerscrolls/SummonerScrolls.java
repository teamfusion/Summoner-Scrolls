...
public class SummonerScrolls {
    ...
    public static final ModInstance INSTANCE = ModInstance.create(MOD_ID).build();//.client(SSClient::commonClientInitialize).postClient(SSClient::postClientInitialize).build();
