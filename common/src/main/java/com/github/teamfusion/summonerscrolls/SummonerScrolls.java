...
import com.github.teamfusion.summonerscrolls.common.registry.SSCreativeTabs;
...
public class SummonerScrolls {
    ...
    public static final ModInstance INSTANCE = ModInstance.create(MOD_ID)
        .client(SSClient::commonClientInitialize)
        .postClient(SSClient::postClientInitialize)
        .build();
