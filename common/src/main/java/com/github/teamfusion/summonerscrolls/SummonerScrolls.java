...
public class SummonerScrolls {
    ...
    public static final ModInstance INSTANCE = ModInstance.create(MOD_ID).common(SummonerScrolls::commonInitialize).client(SSClient::commonClientInitialize).postClient(SSClient::postClientInitialize).build();
