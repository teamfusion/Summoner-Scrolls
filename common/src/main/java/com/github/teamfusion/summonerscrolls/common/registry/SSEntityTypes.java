...
//    public static final Supplier<EntityType<>> BEE_SUMMON = ENTITY_TYPES.register("bee_summon", ZombieSummon.TYPE);
...
//    public static final Supplier<EntityType<>> PIGLIN_SUMMON = ENTITY_TYPES.register("piglin_summon", ZombieSummon.TYPE);
